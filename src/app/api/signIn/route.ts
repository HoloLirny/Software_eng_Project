  ...
  const token = jwt.sign(
    {
      //   id: user.id,
      //   email: user.email,
      //   user_role: user.user_role, //Add user role to payload if needed
      //Add other fields you want to include in payload if needed
      //For example, if you want to include student name in payload
      //Add cmuBasicInfo.firstname_TH to payload
