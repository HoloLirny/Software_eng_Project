...
import CourseConfig from '../app/(Frontend)/courseConfig/page'
import { useAuthStore } from "@/app/store/useAuthStore";
import Attendance from '../app/(Frontend)/attendance/page'
import { useRouter } from "next/navigation";
import Scan from '../app/(Frontend)/scan/page';
...
function Page() {
    ...
    // }, [changeOpen, editOpen, addOpen, selectedCourse, user?.cmuitaccount,courses]); // Add user.cmuitaccount as a dependency
  ...
  console.log(user)
    ...
    <>
        { user && pages == "courseconfig" ? (
                <CourseConfig course_id={selectcourseconfig} pages={pages} setPages={setPages} user={user} role={studentRole}/>
            ):  user && pages == "attendance" ? (
                <Attendance course_id={selectcourseconfig} pages={pages} setPages={setPages } user={user} role={studentRole}/>
            ...
            >
                ...
                pages == "scan" ? (
                    <Scan student_id={user.student_id}/>
                ):(
                <Box
                    sx={{
                        minHeight: '100vh',
